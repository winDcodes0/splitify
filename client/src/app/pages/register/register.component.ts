...
@Component({
        ...
        <div class="auth-card glass-card-static">
          <div class="auth-header">
            <svg width="40" height="40" viewBox="0 0 32 32" fill="none">
              ...
              <defs><linearGradient id="regGrad" x1="0" y1="0" x2="32" y2="32"><stop stop-color="#00cec9"/><stop offset="1" stop-color="#81ecec"/></linearGradient></defs>
            </svg>
            <h1>Create your account</h1>
            <p>Start splitting expenses in seconds</p>
          </div>
                ...
                <div class="password-strength">
                  <div class="strength-bar">
                    <div class="strength-fill"
                         ...
                         [style.background]="getPasswordStrength() > 66 ? 'var(--color-success)' : getPasswordStrength() > 33 ? 'var(--color-warning)' : 'var(--color-danger)'">
                    </div>
                  </div>
                  <span class="strength-label">
                    {{ getPasswordStrength() > 66 ? 'Strong' : getPasswordStrength() > 33 ? 'Medium' : 'Weak' }}
                  </span>
                </div>
              }
            </div>
  ...
  styles: [`
    ...
    .auth-header svg { margin-bottom: var(--space-md); }
    .auth-header h1 { font-size: 1.6rem; font-weight: 700; margin-bottom: var(--space-xs); }
    ...
    .password-toggle {
      ...
      cursor: pointer; padding: 4px; transition: color var(--transition-fast);
    }
    ...
    .strength-label {
      font-size: 0.75rem; color: var(--text-tertiary); white-space: nowrap;
    }
    ...
    .auth-footer a { color: var(--accent-purple-light); font-weight: 500; }
